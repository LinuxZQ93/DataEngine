...
public:
    ...
    */
    ...
    virtual bool attachRpc() = 0;
    virtual bool sendRpcEvent(const std::string &code, const Json::Value &cfgEvent) = 0;
    /// 目前RPC只支持Json格式
    virtual bool sendRpcEvent(const std::string &code, const base::any &value, base::any &result) = 0;
};
