...
class ITcpClientHandleMessage : public IHandleMessage {
public:
    ITcpClientHandleMessage(){}
    virtual ~ITcpClientHandleMessage(){}
public:
    /**
    *@brief 客户端上线通知
    *@param ip 客户端的ip
    ...
    *@return void
    */
    virtual void serverConnected(const std::string &ip, int port, int fd){}
    /**
    *@brief 客户端离线通知
    *@param ip 客户端的ip
    *@param port 客户端的端口
    ...
    *@return void
    */
    virtual void serverDisconnect(const std::string &ip, int port, int fd){}
};
